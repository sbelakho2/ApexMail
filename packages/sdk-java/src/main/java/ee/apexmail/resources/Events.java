...
public final class Events {
    ...
    public Map<String, Object> list(Map<String, Object> options) {
        String q = options != null && !options.isEmpty()
            ? "?" + buildQuery(options) : "";
        return client.request("GET", "/v1/events" + q, null);
    }
     ...
     */
    public Map<String, Object> getByMessage(String messageId) {
    ...
    public Map<String, Object> get(String eventId) {
        return client.request("GET", "/v1/events/" + encode(eventId), null);
    }
