//! KiwiCaptcha widget — zero-dependency proof-of-work security.
...
// package` verification can compile the packaged representation without
// reaching outside the crate. The
