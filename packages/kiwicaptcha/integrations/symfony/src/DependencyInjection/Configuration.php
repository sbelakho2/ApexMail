                ...
                ->arrayNode('risk')
                    ...
                    ->children()
                        ...
                        ->scalarNode('network_classifier_file')
                            ->info('Optional path to a local CIDR classifier file (lines "cidr,reserved|hosting|proxy|tor|blocked"). No runtime lookups; the IP never leaves the server.')
                            ->defaultNull()
                        ->end()
                        ...
                        ->arrayNode('calibration')
                            ->info('Privacy-preserving aggregate calibration: score-bucket statistics (no identity, no IP, no pseudonym) with a bounded scope-bias adjustment.')
                            ->addDefaultsIfNotSet()
                            ->children()
