                ...
                ->arrayNode('risk')
                    ...
                    ->children()
                        ...
                        ->arrayNode('sitekey_allowlist')
                            ...
                            ->defaultValue([])
                        ->end()
                        ->scalarNode('siteverify_secret')
                            ->info('PROVIDER-COMPATIBLE SITEVERIFY SECRET (round 24): the server-to-server secret for the {prefix}/siteverify endpoint. null (default) DISABLES the endpoint. The secret authenticates application backends (never browsers — a browser must not see it), and `remoteip` is only honored after it is presented.')
                            ->defaultNull()
                        ->end()
