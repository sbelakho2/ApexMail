...
final class RealRedisPostSolveDispositionTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->client = new \Predis\Client(self::redisTestUrl());
        try {
            $this->client->ping();
        } catch (\Throwable $e) {
    ...
    public function testFreshPathIssuesExactlyClaimAndFinalizeCommandsAgainstRealRedis(): void
    {
        ...
        // finalize.
        $counting = new class(self::redisTestUrl(), ['timeout' => 2.0, 'read_write_timeout' => 2.0]) extends \Predis\Client {
...
// ── the verified replica-WAIT durability barrier ────────────────────────────
    ...
    {
        return new CommandCountingRedisClient(self::redisTestUrl(), ['timeout' => 2.0, 'read_write_timeout' => 2.0]);
    }
