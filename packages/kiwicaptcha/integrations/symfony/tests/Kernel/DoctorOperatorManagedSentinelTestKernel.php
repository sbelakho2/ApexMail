 ...
 * posture with a Predis Sentinel replication aggregate wired as the
 * storage/limiter client. The build accepts it (the operator owns
 * promotion eligibility) and the doctor must report the
 * replication-topology check PASSing with the operator contract
 * noted.
 */
class DoctorOperatorManagedSentinelTestKernel extends TestKernel
{
