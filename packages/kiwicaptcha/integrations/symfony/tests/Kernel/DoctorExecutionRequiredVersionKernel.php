 ...
 * configured and the execution_version cap is raised to 2. The cap
 * can also stay at 1 for the no-capability scenario. The doctor's
 * protocol-v3 writer check passes once the test seeds the central
 * policy floors (protocol 4 + execution 2). The variants differ in
 * the node cap and the execution_required_version knob, so each
