(function () {
  ...
  var packs = {
    de: { dir: "ltr",
      label: "Sicherheitspr\u00fcfung", badgeIdle: "", badgeWait: "Pr\u00fcfe\u2026",
      badgeWorking: "Pr\u00fcfe\u2026", badgeSuccess: "Verifiziert.", badgeFailed: "Erneut versuchen.",
      ...
      hintProtected: "Gesch\u00fctzt durch KiwiCaptcha", hintRetrying: "Pr\u00fcfung fehlgeschlagen ({msg}) \u2014 neuer Versuch\u2026",
      hintClickRetry: "Pr\u00fcfung fehlgeschlagen ({msg}) \u2014 dr\u00fccken Sie die Schaltfl\u00e4che Erneut.",
      hintVerified: "Pr\u00fcfung abgeschlossen.",
      hintExpired: "Pr\u00fcfung abgelaufen \u2014 dr\u00fccken Sie die Schaltfl\u00e4che Erneut.",
      ...
      retryButton: "Erneut", checking: "Pr\u00fcfe\u2026" },
    fr: { dir: "ltr",
      label: "Contr\u00f4le de s\u00e9curit\u00e9", badgeIdle: "", badgeWait: "V\u00e9rification\u2026",
      badgeWorking: "V\u00e9rification\u2026", badgeSuccess: "V\u00e9rifi\u00e9.", badgeFailed: "R\u00e9essayer.",
      ...
      hintProtected: "Prot\u00e9g\u00e9 par KiwiCaptcha", hintRetrying: "V\u00e9rification \u00e9chou\u00e9e ({msg}) \u2014 nouvelle tentative\u2026",
      hintClickRetry: "V\u00e9rification \u00e9chou\u00e9e ({msg}) \u2014 appuyez sur le bouton R\u00e9essayer.",
      hintVerified: "V\u00e9rification termin\u00e9e.",
      hintExpired: "V\u00e9rification expir\u00e9e \u2014 appuyez sur le bouton R\u00e9essayer.",
      ...
      retryButton: "R\u00e9essayer", checking: "V\u00e9rification\u2026" },
    es: { dir: "ltr",
      label: "Comprobaci\u00f3n de seguridad", badgeIdle: "", badgeWait: "Comprobando\u2026",
      badgeWorking: "Comprobando\u2026", badgeSuccess: "Verificado.", badgeFailed: "Int\u00e9ntelo de nuevo.",
      ...
      hintProtected: "Protegido por KiwiCaptcha", hintRetrying: "Verificaci\u00f3n fallida ({msg}) \u2014 reintentando\u2026",
      hintClickRetry: "Verificaci\u00f3n fallida ({msg}) \u2014 pulse el bot\u00f3n Reintentar.",
      hintVerified: "Verificaci\u00f3n completada.",
      hintExpired: "Verificaci\u00f3n caducada \u2014 pulse el bot\u00f3n Reintentar.",
      ...
      retryButton: "Reintentar", checking: "Verificando\u2026" },
    it: { dir: "ltr",
      label: "Controllo di sicurezza", badgeIdle: "", badgeWait: "Verifica\u2026",
      badgeWorking: "Verifica\u2026", badgeSuccess: "Verificato.", badgeFailed: "Riprova.",
      ...
      hintProtected: "Protetto da KiwiCaptcha", hintRetrying: "Verifica non riuscita ({msg}) \u2014 nuovo tentativo\u2026",
      hintClickRetry: "Verifica non riuscita ({msg}) \u2014 premere il pulsante Riprova.",
      hintVerified: "Verifica completata.",
      hintExpired: "Verifica scaduta \u2014 premere il pulsante Riprova.",
      ...
      retryButton: "Riprova", checking: "Verifica\u2026" },
    nl: { dir: "ltr",
      label: "Beveiligingscontrole", badgeIdle: "", badgeWait: "Controleren\u2026",
      badgeWorking: "Controleren\u2026", badgeSuccess: "Geverifieerd.", badgeFailed: "Opnieuw proberen.",
      badgeExpired: "Verlopen",
      ...
      hintProtected: "Beschermd door KiwiCaptcha", hintRetrying: "Controle mislukt ({msg}) \u2014 opnieuw proberen\u2026",
      hintClickRetry: "Controle mislukt ({msg}) \u2014 druk op de knop Opnieuw.",
      hintVerified: "Controle voltooid.",
      hintExpired: "Controle verlopen \u2014 druk op de knop Opnieuw.",
      ...
      retryButton: "Opnieuw", checking: "Controleren\u2026" },
    pl: { dir: "ltr",
      label: "Kontrola bezpiecze\u0144stwa", badgeIdle: "", badgeWait: "Sprawdzanie\u2026",
      badgeWorking: "Sprawdzanie\u2026", badgeSuccess: "Zweryfikowano.", badgeFailed: "Spr\u00f3buj ponownie.",
      badgeExpired: "Wygas\u0142a",
      ...
      hintProtected: "Chronione przez KiwiCaptcha", hintRetrying: "Weryfikacja nieudana ({msg}) \u2014 ponawianie\u2026",
      hintClickRetry: "Weryfikacja nieudana ({msg}) \u2014 naci\u015bnij przycisk Pon\u00f3w.",
      hintVerified: "Weryfikacja zako\u0144czona.",
      hintExpired: "Weryfikacja wygas\u0142a \u2014 naci\u015bnij przycisk Pon\u00f3w.",
      ...
      retryButton: "Pon\u00f3w", checking: "Weryfikacja\u2026" },
    pt: { dir: "ltr",
      label: "Verifica\u00e7\u00e3o de seguran\u00e7a", badgeIdle: "", badgeWait: "A verificar\u2026",
      badgeWorking: "A verificar\u2026", badgeSuccess: "Verificado.", badgeFailed: "Tente novamente.",
      ...
      hintProtected: "Protegido por KiwiCaptcha", hintRetrying: "Verifica\u00e7\u00e3o falhada ({msg}) \u2014 a tentar novamente\u2026",
      hintClickRetry: "Verifica\u00e7\u00e3o falhada ({msg}) \u2014 prima o bot\u00e3o Repetir.",
      hintVerified: "Verifica\u00e7\u00e3o conclu\u00edda.",
      hintExpired: "Verifica\u00e7\u00e3o expirada \u2014 prima o bot\u00e3o Repetir.",
      ...
      retryButton: "Repetir", checking: "A verificar\u2026" },
    ar: { dir: "rtl",
      label: "\u0641\u062d\u0635 \u0627\u0644\u0623\u0645\u0627\u0646", badgeIdle: "", badgeWait: "\u062c\u0627\u0631\u064d \u0627\u0644\u062a\u062d\u0642\u0642\u2026",
      badgeWorking: "\u062c\u0627\u0631\u064d \u0627\u0644\u062a\u062d\u0642\u0642\u2026", badgeSuccess: "\u062a\u0645 \u0627\u0644\u062a\u062d\u0642\u0642.", badgeFailed: "\u062d\u0627\u0648\u0644 \u0645\u062c\u062f\u062f\u064b\u0627.",
      badgeExpired: "\u0645\u0646\u062a\u0647\u064a\u0629",
      ...
      hintProtected: "\u0645\u062d\u0645\u064a \u0628\u0648\u0627\u0633\u0637\u0629 KiwiCaptcha", hintRetrying: "\u0641\u0634\u0644 \u0627\u0644\u062a\u062d\u0642\u0642 ({msg}) \u2014 \u0625\u0639\u0627\u062f\u0629 \u0627\u0644\u0645\u062d\u0627\u0648\u0644\u0629\u2026",
      hintClickRetry: "\u0641\u0634\u0644 \u0627\u0644\u062a\u062d\u0642\u0642 ({msg}) \u2014 \u0627\u0636\u063a\u0637 \u0639\u0644\u0649 \u0632\u0631 \u0625\u0639\u0627\u062f\u0629 \u0627\u0644\u0645\u062d\u0627\u0648\u0644\u0629.",
      hintVerified: "\u0627\u0643\u062a\u0645\u0644 \u0627\u0644\u062a\u062d\u0642\u0642.",
      hintExpired: "\u0627\u0646\u062a\u0647\u062a \u0645\u0647\u0644\u0629 \u0627\u0644\u062a\u062d\u0642\u0642 \u2014 \u0627\u0636\u063a\u0637 \u0632\u0631 \u0625\u0639\u0627\u062f\u0629 \u0627\u0644\u0645\u062d\u0627\u0648\u0644\u0629.",
      ...
      retryButton: "\u0625\u0639\u0627\u062f\u0629 \u0627\u0644\u0645\u062d\u0627\u0648\u0644\u0629", checking: "\u062c\u0627\u0631\u064d \u0627\u0644\u062a\u062d\u0642\u0642\u2026" }
  };
