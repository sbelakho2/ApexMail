...
```bash
curl -X POST https://api.apexmail.io/enterprise/v1/template-workflows \
...
```bash
curl -X POST https://api.apexmail.io/enterprise/v1/templates/{template_id}/submit \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -d '{
...
```bash
curl -X POST https://api.apexmail.io/enterprise/v1/templates/approve \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -d '{
...
```bash
curl https://api.apexmail.io/enterprise/v1/templates/{template_id}/versions \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl https://api.apexmail.io/enterprise/v1/templates/{template_id}/compare \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -G -d "v1=2" -d "v2=3"
```
...
```bash
curl https://api.apexmail.io/enterprise/v1/templates/submissions/{submission_id} \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl https://api.apexmail.io/enterprise/v1/templates/submissions/pending \
  -H "Authorization: Bearer YOUR_API_KEY" \
