...
```bash
curl -X POST https://api.apexmail.io/enterprise/v1/sub-accounts \
...
```bash
curl -X PUT https://api.apexmail.io/enterprise/v1/sub-accounts/{sub_account_id}/quotas \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -d '{
    "quotas": {
...
```bash
curl https://api.apexmail.io/enterprise/v1/sub-accounts \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X PUT https://api.apexmail.io/enterprise/v1/sub-accounts/{sub_account_id} \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -d '{
...
```bash
curl -X POST https://api.apexmail.io/enterprise/v1/sub-accounts/{sub_account_id}/suspend \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -d '{
...
```bash
curl -X DELETE https://api.apexmail.io/enterprise/v1/sub-accounts/{sub_account_id} \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -d '{
...
```bash
curl https://api.apexmail.io/enterprise/v1/sub-accounts/{sub_account_id}/analytics \
  -H "Authorization: Bearer YOUR_API_KEY" \
...
```bash
curl https://api.apexmail.io/enterprise/v1/sub-accounts/analytics/aggregate \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl https://api.apexmail.io/enterprise/v1/sub-accounts/billing \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -G -d "month=2024-01"
```
