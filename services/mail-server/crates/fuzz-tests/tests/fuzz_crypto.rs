...
use apexmail_lib::id::{generate_id, generate_api_key, generate_request_id, generate_webhook_secret};
...
// Also check specific generators
    for _ in 0..100 {
        ...
        assert!(wh_secret.starts_with("whsec_"), "Webhook secret: {wh_secret}");
    }
}
