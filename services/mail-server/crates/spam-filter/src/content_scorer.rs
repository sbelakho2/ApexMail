...
// ═══ Urgency / pressure (30 patterns) ═══
            ...
            ("time is running out", 2.0, "URGENCY_RUNNING_OUT", "Urgency: time running out"),
            ("last chance", 1.5, "URGENCY_LAST_CHANCE", "Urgency: last chance"),
            ("final warning", 2.0, "URGENCY_FINAL_WARNING", "Urgency: final warning"),
            ("hurry", 1.0, "URGENCY_HURRY", "Urgency: hurry"),
            ("act immediately", 2.0, "URGENCY_ACT_IMMEDIATELY", "Urgency: act immediately"),
            ("deadline", 0.8, "URGENCY_DEADLINE", "Urgency: deadline"),
            ("only today", 1.5, "URGENCY_ONLY_TODAY", "Urgency: only today"),
            ("24 hours", 1.0, "URGENCY_24H", "Urgency: 24 hours"),
            ("respond now", 1.5, "URGENCY_RESPOND", "Urgency: respond now"),
            ("take action now", 1.5, "URGENCY_TAKE_ACTION", "Urgency: take action now"),
            ("while supplies last", 1.5, "URGENCY_SUPPLIES", "Urgency: while supplies last"),
            ("offer expires", 1.5, "URGENCY_OFFER_EXPIRES", "Urgency: offer expires"),
            ("don't miss out", 1.5, "URGENCY_MISS_OUT", "Urgency: don't miss out"),
            ("time-sensitive", 1.5, "URGENCY_TIME_SENSITIVE", "Urgency: time-sensitive"),
            ("must respond", 1.5, "URGENCY_MUST_RESPOND", "Urgency: must respond"),
            ("before it's too late", 1.5, "URGENCY_TOO_LATE", "Urgency: before too late"),
            ("apply now", 1.0, "URGENCY_APPLY_NOW", "Urgency: apply now"),
            ("limited availability", 1.5, "URGENCY_LIMITED_AVAIL", "Urgency: limited availability"),
            ("exclusive offer", 1.0, "URGENCY_EXCLUSIVE", "Urgency: exclusive offer"),
            ("one-time offer", 2.0, "URGENCY_ONE_TIME", "Urgency: one-time offer"),
            ("risk free", 1.5, "URGENCY_RISK_FREE", "Urgency: risk free"),
            ("no obligation", 1.0, "URGENCY_NO_OBLIGATION", "Urgency: no obligation"),
...
// ═══ Financial lures (35 patterns) ═══
            ...
            ("cash prize", 2.5, "FINANCIAL_CASH_PRIZE", "Financial: cash prize"),
            ("bank account", 1.5, "FINANCIAL_BANK_ACCT", "Financial: bank account"),
            ("unclaimed funds", 3.0, "FINANCIAL_UNCLAIMED", "Financial: unclaimed funds"),
            ("beneficiary", 2.0, "FINANCIAL_BENEFICIARY", "Financial: beneficiary"),
            ("investment opportunity", 2.0, "FINANCIAL_INVEST_OPP", "Financial: investment opportunity"),
            ("guaranteed income", 2.5, "FINANCIAL_GUARANTEED", "Financial: guaranteed income"),
            ("make money fast", 3.0, "FINANCIAL_MAKE_FAST", "Financial: make money fast"),
            ("earn money from home", 2.0, "FINANCIAL_FROM_HOME", "Financial: earn money from home"),
            ("double your money", 3.0, "FINANCIAL_DOUBLE", "Financial: double your money"),
            ("no fees", 1.0, "FINANCIAL_NO_FEES", "Financial: no fees"),
            ("tax refund", 1.5, "FINANCIAL_TAX_REFUND", "Financial: tax refund"),
            ("credit card offer", 1.5, "FINANCIAL_CC_OFFER", "Financial: credit card offer"),
            ("pre-approved", 1.5, "FINANCIAL_PREAPPROVED", "Financial: pre-approved"),
            ("debt consolidation", 1.0, "FINANCIAL_DEBT_CONSOL", "Financial: debt consolidation"),
            ("low interest rate", 1.0, "FINANCIAL_LOW_INTEREST", "Financial: low interest rate"),
            ("financial freedom", 1.5, "FINANCIAL_FREEDOM", "Financial: financial freedom"),
            ("quick loan", 2.0, "FINANCIAL_QUICK_LOAN", "Financial: quick loan"),
            ("100% free", 2.0, "FINANCIAL_100_FREE", "Financial: 100% free"),
            ("money back guarantee", 1.0, "FINANCIAL_MONEY_BACK", "Financial: money back guarantee"),
            ("no credit check", 2.0, "FINANCIAL_NO_CREDIT", "Financial: no credit check"),
            ("cash bonus", 2.0, "FINANCIAL_CASH_BONUS", "Financial: cash bonus"),
            ("government grant", 2.5, "FINANCIAL_GOV_GRANT", "Financial: government grant"),
            ("secret method", 2.5, "FINANCIAL_SECRET", "Financial: secret method"),
            ("work from home", 1.5, "FINANCIAL_WFH", "Financial: work from home"),
            ("be your own boss", 1.5, "FINANCIAL_OWN_BOSS", "Financial: be your own boss"),
...
// ═══ Pharma / health spam (25 patterns) ═══
            ...
            ("lose weight fast", 2.0, "PHARMA_LOSE_FAST", "Pharma: lose weight fast"),
            ("fat burner", 2.0, "PHARMA_FAT_BURNER", "Pharma: fat burner"),
            ("appetite suppressant", 1.5, "PHARMA_APPETITE", "Pharma: appetite suppressant"),
            ("muscle growth", 1.5, "PHARMA_MUSCLE", "Pharma: muscle growth"),
            ("testosterone boost", 2.0, "PHARMA_TESTOSTERONE", "Pharma: testosterone boost"),
            ("erectile dysfunction", 2.0, "PHARMA_ED", "Pharma: erectile dysfunction"),
            ("cheap medication", 2.0, "PHARMA_CHEAP_MED", "Pharma: cheap medication"),
            ("online pharmacy", 2.0, "PHARMA_ONLINE", "Pharma: online pharmacy"),
            ("no prescription", 2.5, "PHARMA_NO_RX", "Pharma: no prescription"),
            ("canadian pharmacy", 2.0, "PHARMA_CANADIAN", "Pharma: canadian pharmacy"),
            ("generic pills", 1.5, "PHARMA_GENERIC_PILLS", "Pharma: generic pills"),
            ("order now", 1.0, "PHARMA_ORDER_NOW", "Pharma: order now"),
            ("herbal supplement", 1.0, "PHARMA_HERBAL", "Pharma: herbal supplement"),
            ("miracle cure", 3.0, "PHARMA_MIRACLE", "Pharma: miracle cure"),
            ...
            ("natural remedy", 0.8, "PHARMA_NATURAL", "Pharma: natural remedy"),
...
// ═══ Credential phishing (40 patterns) ═══
            ...
            ("your account has been", 2.0, "PHISH_ACCT_HAS_BEEN", "Phishing: your account has been"),
            ("unusual activity", 2.0, "PHISH_UNUSUAL", "Phishing: unusual activity"),
            ("unauthorized access", 2.0, "PHISH_UNAUTHORIZED", "Phishing: unauthorized access"),
            ("reset your password", 1.5, "PHISH_RESET_PW", "Phishing: reset your password"),
            ("secure your account", 2.0, "PHISH_SECURE", "Phishing: secure your account"),
            ("verify your email", 1.5, "PHISH_VERIFY_EMAIL", "Phishing: verify your email"),
            ("sign in immediately", 2.0, "PHISH_SIGN_IN", "Phishing: sign in immediately"),
            ("security alert", 2.0, "PHISH_SECURITY_ALERT", "Phishing: security alert"),
            ("confirm your email", 1.5, "PHISH_CONFIRM_EMAIL", "Phishing: confirm your email"),
            ("update your information", 2.0, "PHISH_UPDATE_INFO", "Phishing: update your information"),
            ("account will be closed", 2.5, "PHISH_ACCT_CLOSED", "Phishing: account will be closed"),
            ("billing problem", 2.0, "PHISH_BILLING", "Phishing: billing problem"),
            ("invoice attached", 1.5, "PHISH_INVOICE", "Phishing: invoice attached"),
            ("document shared", 1.0, "PHISH_DOC_SHARED", "Phishing: document shared"),
            ("shared a file with you", 1.0, "PHISH_FILE_SHARED", "Phishing: file shared with you"),
            ("sign in to view", 1.5, "PHISH_SIGN_VIEW", "Phishing: sign in to view"),
            ("click below to confirm", 2.0, "PHISH_CLICK_CONFIRM", "Phishing: click to confirm"),
            ("validate your account", 2.0, "PHISH_VALIDATE", "Phishing: validate your account"),
            ("unable to process", 1.5, "PHISH_UNABLE_PROCESS", "Phishing: unable to process"),
            ("payment declined", 2.0, "PHISH_PAYMENT_DECLINED", "Phishing: payment declined"),
            ("suspicious login", 2.0, "PHISH_SUSPICIOUS_LOGIN", "Phishing: suspicious login"),
            ("password expired", 1.5, "PHISH_PW_EXPIRED", "Phishing: password expired"),
            ("account locked", 2.0, "PHISH_ACCT_LOCKED", "Phishing: account locked"),
            ("failed delivery", 1.5, "PHISH_FAILED_DELIVERY", "Phishing: failed delivery"),
            ("package notification", 1.5, "PHISH_PACKAGE", "Phishing: package notification"),
            ("shipment tracking", 1.0, "PHISH_SHIPMENT", "Phishing: shipment tracking"),
            ("you have a new message", 1.0, "PHISH_NEW_MSG", "Phishing: you have a new message"),
            ("voicemail notification", 1.5, "PHISH_VOICEMAIL", "Phishing: voicemail notification"),
            ("action required", 2.0, "PHISH_ACTION_REQ", "Phishing: action required"),
            ("re-verify", 2.0, "PHISH_REVERIFY", "Phishing: re-verify"),
            ("unlock your account", 2.0, "PHISH_UNLOCK", "Phishing: unlock your account"),
            ("update credit card", 2.5, "PHISH_UPDATE_CC", "Phishing: update credit card"),
            ("paypal security", 2.0, "PHISH_PAYPAL", "Phishing: paypal security"),
...
// ═══ Advance-fee / 419 scams (20 patterns) ═══
            ...
            ("next of kin", 3.0, "AFF_NEXT_OF_KIN", "AFF scam: next of kin"),
            ("business proposal", 2.0, "AFF_BUSINESS", "AFF scam: business proposal"),
            ("barrister", 2.5, "AFF_BARRISTER", "AFF scam: barrister"),
            ("diplomatic courier", 3.0, "AFF_DIPLOMATIC", "AFF scam: diplomatic courier"),
            ("consignment box", 3.0, "AFF_CONSIGNMENT", "AFF scam: consignment box"),
            ("trunk box", 3.0, "AFF_TRUNK_BOX", "AFF scam: trunk box"),
            ("compensation fund", 2.5, "AFF_COMPENSATION", "AFF scam: compensation fund"),
            ("deceased client", 3.0, "AFF_DECEASED", "AFF scam: deceased client"),
            ("release the fund", 3.0, "AFF_RELEASE_FUND", "AFF scam: release the fund"),
            ("central bank", 2.0, "AFF_CENTRAL_BANK", "AFF scam: central bank"),
            ("foreign minister", 2.5, "AFF_FOREIGN_MIN", "AFF scam: foreign minister"),
            ("atm card", 2.5, "AFF_ATM_CARD", "AFF scam: atm card"),
            ("consulate general", 2.0, "AFF_CONSULATE", "AFF scam: consulate general"),
            ("fund transfer", 2.0, "AFF_FUND_TRANSFER", "AFF scam: fund transfer"),
            ("western union", 2.0, "AFF_WESTERN_UNION", "AFF scam: western union"),
...
// ═══ Adult / dating spam (15 patterns) ═══
            ...
            ("lonely wife", 2.5, "ADULT_LONELY", "Adult spam: lonely wife"),
            ("dating match", 1.5, "ADULT_DATING", "Adult spam: dating match"),
            ("mature women", 2.0, "ADULT_MATURE", "Adult spam: mature women"),
            ("discreet affair", 2.5, "ADULT_AFFAIR", "Adult spam: discreet affair"),
            ("singles in your area", 2.0, "ADULT_AREA", "Adult spam: singles in your area"),
            ("no strings attached", 1.5, "ADULT_NO_STRINGS", "Adult spam: no strings"),
            ("cam girl", 2.5, "ADULT_CAM", "Adult spam: cam girl"),
            ("chat now", 1.0, "ADULT_CHAT", "Adult spam: chat now"),
            ("sexual enhancement", 2.5, "ADULT_ENHANCEMENT", "Adult spam: sexual enhancement"),
...
// ═══ Sextortion / blackmail (12 patterns) ═══
            ...
            ("video of you", 3.0, "SEXTORT_VIDEO", "Sextortion: video of you"),
            ("send bitcoin", 3.0, "SEXTORT_BITCOIN", "Sextortion: send bitcoin"),
            ("embarrassing video", 3.5, "SEXTORT_EMBARRASS", "Sextortion: embarrassing video"),
            ("recorded you", 3.0, "SEXTORT_RECORDED", "Sextortion: recorded you"),
            ("shared with contacts", 3.0, "SEXTORT_SHARED", "Sextortion: shared with contacts"),
            ("compromising material", 3.5, "SEXTORT_COMPROMISE", "Sextortion: compromising material"),
            ("adult website", 2.5, "SEXTORT_ADULT_SITE", "Sextortion: adult website"),
...
// ═══ COVID / health scare (10 patterns) ═══
            ...
            ("stimulus check", 2.0, "COVID_STIMULUS", "COVID scam: stimulus check"),
            ("health alert", 1.0, "COVID_HEALTH_ALERT", "COVID: health alert"),
            ("quarantine order", 1.5, "COVID_QUARANTINE", "COVID scam: quarantine order"),
            ("covid test results", 1.5, "COVID_TEST", "COVID scam: test results"),
            ("face mask offer", 1.5, "COVID_MASK", "COVID scam: face mask"),
...
// ═══ Tech support / impersonation (15 patterns) ═══
            ...
            ("call this number", 1.5, "TECHSUP_CALL", "Tech support: call number"),
            ("remote access", 2.0, "TECHSUP_REMOTE", "Tech support: remote access"),
            ("windows alert", 2.0, "TECHSUP_WINDOWS", "Tech support: windows alert"),
            ("apple support", 1.5, "TECHSUP_APPLE", "Tech support: apple support"),
            ("your device has", 1.5, "TECHSUP_DEVICE", "Tech support: your device"),
            ("security breach detected", 2.0, "TECHSUP_BREACH", "Tech support: security breach"),
            ("firewall alert", 2.0, "TECHSUP_FIREWALL", "Tech support: firewall alert"),
            ("antivirus expired", 2.0, "TECHSUP_AV_EXPIRED", "Tech support: antivirus expired"),
            ("subscription renewal", 1.5, "TECHSUP_RENEWAL", "Tech support: renewal"),
            ("geek squad", 1.5, "TECHSUP_GEEKSQUAD", "Tech support: geek squad"),
...
// ═══ Job / employment scams (10 patterns) ═══
            ...
            ("stuffing envelopes", 2.5, "JOB_ENVELOPES", "Job scam: stuffing envelopes"),
            ("secret shopper", 2.0, "JOB_SECRET_SHOPPER", "Job scam: secret shopper"),
            ("mystery shopper", 2.0, "JOB_MYSTERY_SHOPPER", "Job scam: mystery shopper"),
            ("part-time income", 1.0, "JOB_PART_TIME", "Job scam: part-time income"),
            ("no experience needed", 1.5, "JOB_NO_EXP", "Job scam: no experience"),
...
// ═══ Legal / threats (8 patterns) ═══
            ...
            ("warrant for arrest", 3.0, "LEGAL_WARRANT", "Legal threat: warrant for arrest"),
            ("court summons", 2.5, "LEGAL_SUMMONS", "Legal threat: court summons"),
            ("irs notification", 2.0, "LEGAL_IRS", "Legal threat: IRS notification"),
