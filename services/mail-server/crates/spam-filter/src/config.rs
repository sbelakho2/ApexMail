...
// Major/popular URL shorteners
                "bit.ly".into(), "tinyurl.com".into(), "t.co".into(),
                "goo.gl".into(), "ow.ly".into(), "is.gd".into(),
                "buff.ly".into(), "rebrand.ly".into(), "bl.ink".into(),
                "short.io".into(), "cutt.ly".into(), "rb.gy".into(),
                "v.gd".into(), "shorte.st".into(), "adf.ly".into(),
// Additional shorteners often used in spam
                "tiny.cc".into(), "clck.ru".into(), "x.co".into(),
                "lnkd.in".into(), "fb.me".into(), "youtu.be".into(),
                "soo.gd".into(), "s.id".into(), "rotf.lol".into(),
                "shorturl.at".into(), "1url.com".into(), "hyperurl.co".into(),
            ],
