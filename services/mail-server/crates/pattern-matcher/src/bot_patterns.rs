...
mod tests {
    ...
    fn test_bot_detector_recognizes_googlebot() {
        ...
        assert!(detector.is_match("Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)"));
    }
    ...
    fn test_bot_detector_pattern_count() {
        ...
        assert!(patterns.len() >= 70, "Should have 70+ patterns, got {}", patterns.len());
    }
