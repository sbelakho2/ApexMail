...
) -> Result<Vec<JsonPathValue>, String> {
    *node_count += 1;
...
mod tests {
    ...
    fn test_nested_json() {
        ...
        assert!(result
            .string_values
            .iter()
            .any(|v| v.value == "SELECT * FROM users"));
    }
    ...
    fn test_sqli_in_json() {
        ...
        assert!(result
            .string_values
            .iter()
            .any(|v| v.value.contains("DROP TABLE")));
    }
