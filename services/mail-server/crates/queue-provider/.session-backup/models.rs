...
pub struct StoredMessage {
    ...
    /// Delivery-scoped dedup (migration 102): TRUE for user-initiated copies,
    /// which are exempt from the per-mailbox Message-ID unique index. The
    /// SMTP delivery path keeps FALSE so redelivery collapses.
    pub dedup_exempt: bool,
