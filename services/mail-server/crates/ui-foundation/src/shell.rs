...
fn render_web_sidebar(current_path: &str) -> String {
    ...
    format!(
        "<div class=\"apex-console-sidebar flex flex-col h-full bg-white border-r border-surface-200\">\
...
fn render_cp_sidebar(current_path: &str) -> String {
    ...
    format!(
        "<div class=\"apex-cp-sidebar flex flex-col h-full bg-surface-950 text-white\">\
         ...
         <div class=\"flex-1 overflow-y-auto cp-sidebar-nav\">{}</div>\
