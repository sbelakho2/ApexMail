...
impl<'a> MarketingHeader<'a> {
    pub fn render_html(&self) -> String {
        ...
        format!(
            ...
            if self.is_scrolled {
                "bg-card/80 backdrop-blur-xl border-b border-surface-200/50 "
            } else {
