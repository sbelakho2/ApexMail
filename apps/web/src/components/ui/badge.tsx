...
const badgeVariants = cva(
  'inline-flex items-center rounded-sm border px-2.5 py-1 text-[14px] font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
