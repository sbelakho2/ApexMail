...
export function getMCaptchaWidgetUrl(): string | null {
  if (process.env.NEXT_PUBLIC_MCAPTCHA_ENABLED !== 'true') {
    return null;
  }

  return process.env.NEXT_PUBLIC_MCAPTCHA_WIDGET_URL?.trim() || null;
}