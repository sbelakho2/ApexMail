        ...
        <div className="bg-card rounded-2xl shadow-xl border border-border overflow-hidden">
          ...
          <div className="px-8 pb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <button disabled className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-border hover:bg-accent hover:border-accent-foreground/10 transition-all opacity-60 cursor-not-allowed">
