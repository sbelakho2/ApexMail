...
export function CalculatorCTA() {
 ...
 <div key={item.label}>
 <div className="text-2xl font-bold text-surface-900 tabular-nums">{item.value}</div>
 ...
 <Link href="/pricing/faq" className="text-primary-600 font-bold hover:underline">
 Check our FAQ
 </Link>{' '}
 or{' '}
