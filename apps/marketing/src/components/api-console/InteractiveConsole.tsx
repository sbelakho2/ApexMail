...
export function InteractiveConsole() {
 ...
 <button
 onClick={copyCode}
 className="flex items-center gap-1 px-3 py-1 text-xs font-bold text-surface-500 hover:text-primary-600 transition-colors"
 >
 ...
 onClick={handleSend}
 disabled={isLoading}
 className="btn-primary flex items-center gap-2 py-2 px-4 text-xs font-bold"
 >
 {isLoading ? (
 ...
 <pre className="text-[13px] text-surface-300 font-mono bg-surface-900 p-4 rounded-md overflow-auto shadow-inner">
 ...
 <span className="text-xs font-bold uppercase tracking-widest">Click "Send Request" to see the response</span>
 </div>
 )}
 </div>
 )}
 ...
 <span className="text-xs font-bold uppercase tracking-widest">Webhooks will appear here in real-time</span>
 </div>
 ) : (
 ...
 className="bg-surface-50 border border-surface-100 rounded-md p-4"
 >
 ...
 <pre className="text-[11px] text-surface-500 font-mono bg-white p-2 rounded-sm border border-surface-100 overflow-auto">
