...
export function ForensicCTA() {
 ...
 >
 <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-orange-50 text-orange-700 border border-orange-100 text-[10px] font-bold uppercase tracking-widest mb-6">
