...
const comparisonData = {
  ...
  categories: [
    ...
    },
    {
      ...
      features: [
        ...
        { name: 'HIPAA BAA', apexmail: 'Yes', competitor: 'Part of AWS BAA', winner: 'tie' },
        { name: 'Audit Logs', apexmail: 'Built-in', competitor: 'CloudTrail setup', winner: 'apexmail' },
    ...
    },
    {
      name: 'Pricing',
      features: [
        { name: 'Free Tier', apexmail: '1,000/mo forever', competitor: '62,000/mo (from EC2 only)', winner: 'competitor' },
  ...
  verdict: {
    ...
    points: [
      ...
      'Built-in compliance tools for GDPR and HIPAA',
      'Rich analytics dashboard without CloudWatch complexity',
      'AI-powered features: send-time optimization, content analysis',
