/**
 * Tailwind CSS Configuration — Zola Marketing Site
 *
 * Standalone config (no TypeScript). Used with:
  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        glow: {
          '0%': { boxShadow: '0 0 20px rgba(91, 115, 241, 0.3)' },
          '100%': { boxShadow: '0 0 40px rgba(91, 115, 241, 0.6)' },
        },
        slideUp: {
