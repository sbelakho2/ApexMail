...
- **SOC-2-Control-Mapping** — Dokumentation zum Control-Mapping nach den SOC-2-Trust-Services-Criteria und zur Bereitschaftsbewertung (Hinweis: ApexMail ist derzeit nicht SOC-2-zertifiziert).
