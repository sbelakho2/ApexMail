...
|---|---|---|---|---|---|---|---|---|---|---|
| Hetzner Online GmbH | Hetzner | Cloud hosting | Compute, storage, networking | All service data | Germany, Finland | Germany, Finland | Germany | Not applicable — processing remains within the EEA | Yes |
...
|---|---|---|---|---|---|---|
| ClickHouse (open-source) | Analytics database | Delivery events, open/click events, bounce/complaint data | Germany, Finland | Germany, Finland | Self-hosted on Hetzner. ClickHouse, Inc. does not process customer data. |
| Redis (open-source) | In-memory cache | Session tokens, rate limit counters | Germany, Finland | Germany, Finland | Self-hosted on Hetzner. Redis Ltd. does not process customer data. |
