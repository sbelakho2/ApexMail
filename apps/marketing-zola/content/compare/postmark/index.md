...
comparison_sections = [
  ...
  { title = "COMPLIANCE", rows = [
    ...
    { feature = "Audit Logs", apex = '<span class="text-brand-600 font-semibold">Operator + API audit trail</span>', comp = '<span class="text-surface-600">Event logs only</span>', winner = "none" },
