...
export default function CookieConsent() {
  ...
  return (
    <div class="fixed inset-x-0 bottom-0 z-50 border-t border-surface-200 bg-surface-50/95 backdrop-blur px-4 py-3">
      <div class="mx-auto flex max-w-6xl flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <p class="text-sm text-surface-600">
          ...
          See our{' '}
          <a href="/cookies" class="font-semibold text-surface-900 underline">
            Cookie Policy
          </a>
          .
        </p>
