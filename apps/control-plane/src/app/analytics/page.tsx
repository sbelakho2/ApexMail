...
import { cn, formatDateOnly, formatDateTime, getLocalTimeZone } from '../../lib/utils';
...
import {
    ...
    AnalyticsSection,
    ANALYTICS_SECTION_TABS,
    buildHeatMapData,
    DELIVERABILITY_BY_ISP,
    TimeRange,
    TIME_RANGE_OPTIONS,
    toShortDate,
    TOP_CAMPAIGNS,
        ...
        <div className="cp-page overflow-x-hidden pb-4 xl:pb-0" ref={printRef}>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 no-print">
                ...
                <div className="flex items-center gap-3 overflow-x-auto">
                    ...
                    <button aria-label="Export analytics as CSV" type="button" onClick={handleExport} className="px-4 py-2 bg-card border border-border text-foreground font-medium rounded-lg text-sm hover:bg-muted shadow-sm transition-colors">
                        Export
                    </button>
                    <button aria-label="Print analytics report" type="button" onClick={handlePrint} className="px-4 py-2 bg-primary text-primary-foreground font-medium rounded-lg text-sm hover:opacity-90 shadow-sm transition-colors">
                        Print Report
                    </button>
                </div>
            </div>
                    ...
                    <div className="bg-card rounded-xl border border-border p-6 shadow-sm">
                        ...
                        <div className="space-y-4">
                            {DELIVERABILITY_BY_ISP.map((isp) => {
                                ...
                                return (
                                    <div key={isp.name} className="flex items-center gap-4">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="bg-card rounded-xl border border-border p-6 shadow-sm">
                            ...
                            <div className="space-y-3">
                                {TOP_CAMPAIGNS.map((c) => (
                                    <div key={c.name} className="p-3 bg-muted rounded-lg border border-border">
